...
window.onmousedown = e=> (inputData[0][e.button] = {d:hadInput=1, p:1}, window.onmousemove(e));
window.onmouseup   = e=> inputData[0][e.button] && (inputData[0][e.button].d = 0, inputData[0][e.button].r = 1);
...
if(debug)
    window.onwheel = e=> e.ctrlKey || (mouseWheel = sign(e.deltaY));
window.oncontextmenu = e=> !1; // prevent right click menu
...
if (enableTouchInput && window.ontouchstart !== undefined)
{
    ...
    window.ontouchstart = window.ontouchmove = window.ontouchend = e=>
    {
        ...
        if (touching)
        {
            ...
            wasTouching ? window.onmousemove(e) : window.onmousedown(e);
        }
        else if (wasTouching)
            wasTouching && window.onmouseup(e);
