...
class Prop extends GameObject 
{
	...
	else if (this.type == propType_crate_nuke)
        {
...
class Bullet extends EngineObject 
{
    ...
    collideWithTile(data, pos)
    {
        ...
        const destroyTileChance = data == tileType_glass || data == tileType_leaf ? 1 : data == tileType_dirt ? .2 : .05;
