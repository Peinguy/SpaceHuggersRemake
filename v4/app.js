...
()=> // appUpdate
{
    ...
    if (keyWasPressed(54))
    {
	if (window.localStorage['Weapondeb'] == "true") {
            if (window.localStorage['PlayerWeapon']) {
	        if (window.localStorage['PlayerWeapon'] == '1') {
		    window.localStorage['PlayerWeapon'] = '2';
	        } else {
	     	    window.localStorage['PlayerWeapon'] = '1';
	        }
	    } else {
	        window.localStorage['PlayerWeapon'] = '2';
	    }
	    window.localStorage['Weapondeb'] = "false";
	    ticker_weapon = 0;
	}
    }
    ticker_weapon++;
    if(ticker_weapon >= 10)
	window.localStorage['Weapondeb'] = "true";
